...
module.exports.run = async (bot, message) => {
    if (message.channel.name === "server-suggestions" || message.channel.name === "📝server-suggestions📝" || message.channel.name === "suggestions" || message.channel.name === "suggestion" || message.channel.name === "server-suggestion" || message.channel.name === "📝suggestions" || message.channel.id === "526946504213135370" || message.channel.id === "524090791262683146") {
        if (message.author.id === "288491554841034752" || message.author.id === "248947473161256972" || message.guild.id === "499409162661396481" || message.author.id === message.guild.ownerID) return;
            message.react("✅")
            message.react("❌")
    }
