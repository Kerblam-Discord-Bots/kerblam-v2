...
message.delete().catch()
  message.reply(`Sorry, that word is blacklisted in The TARDIS system. no im not broken`)
    ...
    if (message.channel.name === "server-suggestions" || message.channel.name === "📝server-suggestions📝" || message.channel.name === "suggestions" || message.channel.name === "suggestion" || message.channel.name === "server-suggestion" || message.channel.name === "📝suggestions" || message.channel.id === "534828372673691660" || message.channel.id === "542461184318898180") {
