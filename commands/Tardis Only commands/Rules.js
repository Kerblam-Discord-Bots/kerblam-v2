...
module.exports = class StaffCommand extends Command {
    ...
    async run(message) {
        ...
        let botembed = new Discord.RichEmbed()
            ...
            .addBlankField()
            .addField("AutoBan", "1. Not listening to staff after being warned Alot   2. Pornographic, disturbing content, or racism.  3. Links to Porn or Racism Sites disturbing stuff   4. Impersonate another human or Bot.   5. Snipping In the Discord   6. No Drama From Other Servers, after being told to stop and not doing so.  7. Bullying The Bear Doctor")
            .addBlankField()
